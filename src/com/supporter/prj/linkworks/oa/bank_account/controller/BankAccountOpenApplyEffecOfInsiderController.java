...
import com.supporter.prj.linkworks.oa.bank_account.service.BankAccountOpenApplyEffecOfInsiderService;
import com.supporter.spring_mvc.AbstractController;

@Controller
@RequestMapping("oa/bankAccountOpenApplyEffecOfInsider")
public class BankAccountOpenApplyEffecOfInsiderController extends AbstractController{
	...
	@Autowired
	private BankAccountOpenApplyEffecOfInsiderService bankAccountOpenApplyEffecOfInsiderService; 
	...
	public @ResponseBody JqGrid getGrid(HttpServletRequest request, JqGridReq jqGridReq, BankAccountOpenApplyEffec bankAccountOpenApplyEffec) throws Exception  {
		...
		this.bankAccountOpenApplyEffecOfInsiderService.getGrid(user, jqGrid, bankAccountOpenApplyEffec);		
		return jqGrid;
	}
	...
	public @ResponseBody BankAccountOpenApplyEffec get(String effectiveId) {
		BankAccountOpenApplyEffec bankAccountOpenApplyEffec = bankAccountOpenApplyEffecOfInsiderService.get(effectiveId);
	...
	public @ResponseBody BankAccountOpenApplyEffec initEditOrViewPage(HttpServletRequest request,JqGridReq jqGridReq,String effectiveId) {
		JqGrid jqGrid = jqGridReq.initJqGrid(request);
		BankAccountOpenApplyEffec entity = bankAccountOpenApplyEffecOfInsiderService.initEditOrViewPage(jqGrid,effectiveId,this.getUserProfile());
		return entity;
	}
	...
	public BankAccountOpenApplyEffec viewPage(String effectiveId) {
		BankAccountOpenApplyEffec entity = bankAccountOpenApplyEffecOfInsiderService.viewPage(effectiveId,this.getUserProfile());
		return entity;
	}
	...
	OperResult<BankAccountOpenApplyEffec> commit(BankAccountOpenApplyEffec bankAccountOpenApplyEffec) {
		...
		BankAccountOpenApplyEffec entity = this.bankAccountOpenApplyEffecOfInsiderService.commit(user,
...
//		return OperResult.succeed(SalaryConstant.I18nKey.SAVE_SUCCESS, null, null);
	...
	public @ResponseBody OperResult batchDel(String effectiveIds) {
		UserProfile user = this.getUserProfile();
		this.bankAccountOpenApplyEffecOfInsiderService.delete(user, effectiveIds);
//		return OperResult.succeed(SalaryConstant.I18nKey.DELETE_SUCCESS, null, null);
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/selectIsOutside")
	public Map<String, String> selectIsOutside()
			throws IOException {
...
//				}
//			}
			HSSFWorkbook wb = this.bankAccountOpenApplyEffecOfInsiderService.getWorkbook(bankAccountOpenApplyEffec,user,jqGrid);
