...
@MappedSuperclass
public class BaseUseSealApply implements java.io.Serializable{
	...
	private static final long serialVersionUID = 1L;
		// Fields
	     ...
	     private String sealType;//用印种类
	     private Long copies;//用印份数
	     ...
	     private String createdDate;//用印申请日期
	     private String sealTypeId;//用印种类id
	     private String senderDeptId;
	     private String senderDept;//用印文件接收单位
	     private String documentName;//用印所需名称
	     private String relatedIds;//会签人id
	     private String relatedNames;//会签人姓名
	     private String applyPerson;
	     private String otherFile;//用印文件名称
