 ...
 */
@MappedSuperclass
public class BaseDocIn implements java.io.Serializable {
	...
	private String extendReaderIds;
	private String extendReaderNames;
	private Long docClassify;
	...
	/** minimal constructor */
	public BaseDocIn(String docId) {
		this.docId = docId;
	}

	/** full constructor */
	public BaseDocIn(String docId, String docNo, String docTitle, String docType,
			Integer docStatus, String deptId, String deptName, String publisherId,
			String publisherName, String draftsmanId, String draftsmanName,
			Long confidentialRank, String keyWords, Long insideOnly,
			Long copyCount, String toDeptId, String toDeptName,
			String CToDeptIds, String CToDeptNames, String topLeaderIds,
			String topLeaderNames, String deptLeaderIds,
			...
			String archivesName, String createdBy, String creatorName,
			String createdDate, String modifiedBy, String modifiedDate,
			String fileName, String fileExt, String publishDate, String examId,
			String examName, String inNo, String emergencyType,
			String recordNo, String extendReaderIds, String extendReaderNames,
			Long docClassify,String procId) {
		this.docId = docId;
		this.docNo = docNo;
		...
		this.extendReaderIds = extendReaderIds;
		this.extendReaderNames = extendReaderNames;
	...
	@Column(name = "DEPT_NAME", length = 512)
	...
	@Column(name = "TO_DEPT_NAME", length = 64)
	...
	@Column(name = "READER_IDS", length = 2046)
	...
	@Column(name = "READER_NAMES", length = 2046)
	...
	@Column(name = "RECORD_NO", length = 16)
	...
	@Column(name = "EXTEND_READER_IDS", length = 2046)
	public String getExtendReaderIds() {
		return this.extendReaderIds;
	}

	public void setExtendReaderIds(String extendReaderIds) {
		this.extendReaderIds = extendReaderIds;
	}

	@Column(name = "EXTEND_READER_NAMES", length = 2046)
	public String getExtendReaderNames() {
		return this.extendReaderNames;
	}

	public void setExtendReaderNames(String extendReaderNames) {
		this.extendReaderNames = extendReaderNames;
	}

	@Column(name = "DOC_CLASSIFY", precision = 22, scale = 0)
	public Long getDocClassify() {
		return this.docClassify;
	}

	public void setDocClassify(Long docClassify) {
		this.docClassify = docClassify;
	}
