 ...
 */
@MappedSuperclass
public class BaseEmpMealRec implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEmpMealRec() {
	}

	/** minimal constructor */
	public BaseEmpMealRec(String recId) {
		this.recId = recId;
	}

	/** full constructor */
	public BaseEmpMealRec(String recId, String applyId, String empId,
