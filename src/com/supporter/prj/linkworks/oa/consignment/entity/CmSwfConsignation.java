 ...
 */
@Entity
@Table(name = "CM_SWF_CONSIGNATION", schema = "")
public class CmSwfConsignation implements java.io.Serializable {
	...
	/** default constructor */
	public CmSwfConsignation() {
	}

	/** minimal constructor */
	public CmSwfConsignation(Long consignId) {
		this.consignId = consignId;
	}

	/** full constructor */
	public CmSwfConsignation(Long consignId, Long consignmentId,
