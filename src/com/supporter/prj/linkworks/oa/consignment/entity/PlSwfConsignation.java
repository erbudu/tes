 ...
 */
@Entity
@Table(name = "PL_SWF_CONSIGNATION", schema = "")
public class PlSwfConsignation implements java.io.Serializable {
	...
	/** default constructor */
	public PlSwfConsignation() {
	}

	/** minimal constructor */
	public PlSwfConsignation(Long consignId) {
		this.consignId = consignId;
	}

	/** full constructor */
	public PlSwfConsignation(Long consignId, Long consignmentId,
