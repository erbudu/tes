 ...
 */
@Entity
@Table(name = "BM_SWF_CONSIGNATION", schema = "")
public class BmSwfConsignation implements java.io.Serializable {
	...
	/** default constructor */
	public BmSwfConsignation() {
	}

	/** minimal constructor */
	public BmSwfConsignation(Long consignId) {
		this.consignId = consignId;
	}

	/** full constructor */
	public BmSwfConsignation(Long consignId, Long consignmentId,
