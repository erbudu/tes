...
/**
 * OaPrjDataMigration entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public class BasePrjDataMigration implements java.io.Serializable {
	...
	/** default constructor */
	public BasePrjDataMigration() {
	}

	/** minimal constructor */
	public BasePrjDataMigration(String prjDataMigrationId) {
		this.prjDataMigrationId = prjDataMigrationId;
	}

	/** full constructor */
	public BasePrjDataMigration(String prjDataMigrationId, String originalDeptId,
			String originalDeptName, String newDeptId, String newDeptName,
			String prjId, String prjName, String createdDeptId,
			String createdDeptName, Long createdById, String createdBy,
			String createdDate, Long modifiedById, String modifiedBy,
			String modifiedDate) {
		this.prjDataMigrationId = prjDataMigrationId;
	...
	// Property accessors
	@Id
	@Column(name = "PRJ_DATA_MIGRATION_ID", unique = true, nullable = false, length = 32)
