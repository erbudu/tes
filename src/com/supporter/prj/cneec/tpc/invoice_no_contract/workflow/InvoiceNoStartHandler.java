...
/**
 *<p>Title: InvoiceNoStartHandler</p>
 *<p>Description:流程开始服务类</p>
 *<p>Company: </p>
 * @author CHENHAO
 * 
 */
public class InvoiceNoStartHandler extends AbstractExecHandler  {
	...
	public Object execute(ExecContext execContext) {
		...
		InvoiceNoContractEntity entity = service.get(invoiceId);//--------------------------------------------根据业务单主键获取业务实体类信息
		 ...
		 if (entity != null) {
			 ...
			 entity.setStatus(InvoiceNoContractConstant.PROCESSING);//-----------------------------------------------------------流程开始审批中状态代码1
