...
@MappedSuperclass
public class BaseContractChangeGoodsChild implements Serializable {
...
//	private String changeId;
	 ...
	 * 无参构造函数.
	 */
	public BaseContractChangeGoodsChild() {
	}
	 ...
	 * @param childId
	 */
	public BaseContractChangeGoodsChild(String childId) {
	...
	@Column(name = "CHILD_ID", nullable = false, length = 32)
