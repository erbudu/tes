...
@MappedSuperclass
public class BaseContractChangeGoods implements Serializable {
...
//	private String changeId;
	 ...
	 * 无参构造函数.
	 */
	public BaseContractChangeGoods() {
	}
	 ...
	 * @param goodsId
	 */
	public BaseContractChangeGoods(String goodsId) {
...
//	}
	...
	@Column(name = "GOODS_OLD_ID", nullable = true, length = 32)
	public String getGoodsOldId() {
		return this.goodsOldId;
	}

	public void setGoodsOldId(String goodsOldId) {
		this.goodsOldId = goodsOldId;
	}
