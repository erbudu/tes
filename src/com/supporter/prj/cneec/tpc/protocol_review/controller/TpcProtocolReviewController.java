...
/**
 * @Title: TpcProtocolReviewController
 * @Description: 控制器类
 * @author: yanweichao
 * @date: 2017-11-14
 * @version: V1.0
 */
@Controller
@RequestMapping("tpc/protocolReview/build")
public class TpcProtocolReviewController extends AbstractController {
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<ProtocolReview> listPage = this.service.getListPage(
			...
			System.out.println(TpcProtocolReviewController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
