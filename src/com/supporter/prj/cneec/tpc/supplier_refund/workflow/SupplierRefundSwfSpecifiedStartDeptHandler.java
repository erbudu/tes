...
/**
 * @Title: SupplierRefundSwfSpecifiedStartDeptHandler
 * @Description: 工作流组织树起始部门程序指定类
 * @author: yanweichao
 * @date: 2017-11-22
 * @version: V1.0
 */
public class SupplierRefundSwfSpecifiedStartDeptHandler extends AbstractExecHandler {
	...
	public Object execute(ExecContext execContext) {
		...
		return supplierRefund.getDeptId();
	}
