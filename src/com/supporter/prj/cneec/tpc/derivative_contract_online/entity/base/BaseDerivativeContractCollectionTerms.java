 ...
 */
@MappedSuperclass
public class BaseDerivativeContractCollectionTerms implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseDerivativeContractCollectionTerms() {
	}
	 ...
	 * @param termsId
	 */
	public BaseDerivativeContractCollectionTerms(String termsId) {
