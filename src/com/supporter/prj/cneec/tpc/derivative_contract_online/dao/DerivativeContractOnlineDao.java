 ...
 */
@Repository
public class DerivativeContractOnlineDao extends MainDaoSupport<DerivativeContractOnline, String> {

	/**
	 * 分页查询
	 */
	public List<DerivativeContractOnline> findPage(JqGrid jqGrid, DerivativeContractOnline contractOnline, String authFilter) {
	...
	public List<DerivativeContractOnline> getList(Map<String, Object> parameters, String authFilter) throws ParseException {
		String hql = getHql(parameters, authFilter);
		return this.retrieve(hql, parameters);
	}

	public ListPage<DerivativeContractOnline> getListPage(ListPage<DerivativeContractOnline> listPage, Map<String, Object> parameters, String authFilter) throws ParseException {
		String hql = getHql(parameters, authFilter);
	...
	private String getHql(Map<String, Object> parameters, String authFilter) throws ParseException {
		...
		hql.append("from " + DerivativeContractOnline.class.getName() + " t where 1=1");
		// 状态(默认为完成)
		Integer swfStatus = (Integer) parameters.get("swfStatus");
		if (swfStatus == null || swfStatus != 0) {
			swfStatus = DerivativeContractOnline.COMPLETED;
		}
