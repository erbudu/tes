...
import com.supporter.prj.cneec.tpc.contract_sign_review.entity.base.BaseContractSignItem;
 ...
 */
@Entity
@Table(name = "TPC_CONTRACT_SIGN_ITEM2", schema = "")
public class ContractSignItem2 extends BaseContractSignItem implements ContractSignItemBean, Serializable {
	 ...
	 * @param itemId
	 */
	public ContractSignItem2(String itemId) {
		super(itemId);
	}

	public ContractSignItem2(int initialReviewType, String parentItemId, String parentItemName, String saleReviewId, String saleContractId) {
		super(initialReviewType, parentItemId, parentItemName, saleReviewId, saleContractId);
	}

	public ContractSignItem2(int initialReviewType, String purchaseReviewId, String purchaseContractId) {
