 ...
 */
@Entity
public class ContractReviewRecord extends BaseContractSignInfor implements java.io.Serializable {
	...
	/** default constructor */
	public ContractReviewRecord() {
		super();
	}

	/** minimal constructor */
	public ContractReviewRecord(String inforId) {
		super(inforId);
	}
