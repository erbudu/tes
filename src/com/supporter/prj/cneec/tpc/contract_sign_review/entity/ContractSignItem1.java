 ...
 */
@Entity
@Table(name = "TPC_CONTRACT_SIGN_ITEM1", schema = "")
public class ContractSignItem1 extends BaseContractSignItem implements ContractSignItemBean, Serializable {
	 ...
	 * @param itemId
	 */
	public ContractSignItem1(String itemId) {
		super(itemId);
	}

	public ContractSignItem1(int initialReviewType, String parentItemId, String parentItemName, String saleReviewId, String saleContractId) {
		super(initialReviewType, parentItemId, parentItemName, saleReviewId, saleContractId);
	}

	public ContractSignItem1(int initialReviewType, String purchaseReviewId, String purchaseContractId) {
