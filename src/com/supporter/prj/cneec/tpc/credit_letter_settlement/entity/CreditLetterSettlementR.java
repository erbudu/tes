...
import com.supporter.prj.cneec.tpc.credit_letter_settlement.entity.base.BaseCreditLetterSettlementR;
 ...
 */
@Entity
@Table(name = "TPC_CREDIT_LETTER_SETTLEMENT_R", schema = "")
public class CreditLetterSettlementR extends BaseCreditLetterSettlementR {
	 ...
	 * 无参构造函数
	 */
	public CreditLetterSettlementR() {
		super();
	}
	 ...
	 * @param contractId
	 */
	public CreditLetterSettlementR(String recordId) {
		super(recordId);
	}

	public boolean equals(Object other) {
		if (!(other instanceof CreditLetterSettlementR)) {
			return false;
		}
		CreditLetterSettlementR castOther = (CreditLetterSettlementR) other;
	...
	public String getYear(){
		return this.getBudgetYear()+"-"+this.getBudgetMonth();
	}
