...
/**
 * @Title: Entity
 * @Description: TPC_PRJ_CONTRACT_TABLE,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2018-03-15
 * @version V1.0
 */
@MappedSuperclass
public class BasePrjContractTable implements Serializable {
	 ...
	 * @param contractId
	 */
	public BasePrjContractTable(String contractId) {
	...
	/**
	 * GET方法: 取得TAX_ITEM_NAME.
	 * 
	 * @return: String TAX_ITEM_NAME
	 */
	...
	/**
	 * SET方法: 设置TAX_ITEM_NAME.
	 * 
	 * @param: String TAX_ITEM_NAME
	 */
