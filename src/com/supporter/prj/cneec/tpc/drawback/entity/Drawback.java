package com.supporter.prj.cneec.tpc.drawback.entity;
...
import com.supporter.prj.cneec.tpc.drawback.entity.base.BaseDrawback;
 ...
 */
@Entity
@Table(name = "TPC_DRAWBACK", schema = "")
public class Drawback extends BaseDrawback implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String MODULE_ID = "TPCDRAWBACK";
	public static final String BUSI_TYPE_DOC = "TPCDRAWBACK_DOC";// 退税单证
	public static final String BUSI_TYPE_CERT = "TPCDRAWBACK_CERT";// 完税证明
	...
	/** minimal constructor */
	public Drawback(String drawbackId) {
		super(drawbackId);
	}
