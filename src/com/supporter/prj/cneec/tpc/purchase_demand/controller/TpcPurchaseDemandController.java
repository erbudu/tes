...
/**
 * @Title: TpcPurchaseDemandController
 * @Description: 控制器类
 * @author: yanweichao
 * @date: 2017-09-26
 * @version: V1.0
 */
@Controller
@RequestMapping("tpc/purchaseDemand/build")
public class TpcPurchaseDemandController extends AbstractController {
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<PurchaseDemand> listPage = this.demandService.getListPage(
			...
			System.out.println(TpcPurchaseDemandController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
