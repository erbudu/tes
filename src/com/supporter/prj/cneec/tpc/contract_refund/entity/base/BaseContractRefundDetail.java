...
/**
 * @Title: Entity
 * @Description: TPC_CONTRACT_REFUNDDETAIL,字段与数据库字段一一对应.
 * @author liuermeng
 * @date 2018-09-12
 * @version V1.0
 */
@MappedSuperclass
public class BaseContractRefundDetail implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractRefundDetail() {
	}
	 ...
	 * @param detailId
	 */
	public BaseContractRefundDetail(String detailId) {
	 ...
	 */
	@Column(name = "REFUND_CLAUSE_ID", nullable = true, length = 64)
