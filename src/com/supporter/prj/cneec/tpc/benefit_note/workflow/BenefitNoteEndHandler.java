...
/**
 * @Title: BenefitNoteEndHandler
 * @Description: 流程结束操作类
 * @author: yanweichao
 * @date: 2018-07-17
 * @version: V1.0
 */
public class BenefitNoteEndHandler extends AbstractExecHandler {
	...
	public Object execute(ExecContext execContext) {
		...
		entity.setSwfStatus(BenefitNote.CONFIRMED);
		entity.setProcId(execContext.getProcId());
		service.update(entity);
		service.completeExam(entity);
		return null;
	}
