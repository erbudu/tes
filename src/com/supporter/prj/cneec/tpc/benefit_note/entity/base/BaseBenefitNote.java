...
/**
 * @Title: Entity
 * @Description: TPC_BENEFIT_NOTE,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2018-06-01
 * @version V1.0
 */
@MappedSuperclass
public class BaseBenefitNote implements Serializable {
	 ...
	 * @param noteId
	 */
	public BaseBenefitNote(String noteId) {
		this.noteId = noteId;
	}
	...
	@Column(name = "HAS_SWF_PROC", nullable = true, length = 1)
	public boolean isHasSwfProc() {
		return this.hasSwfProc;
	}

	public void setHasSwfProc(boolean hasSwfProc) {
		this.hasSwfProc = hasSwfProc;
	}
