...
/**
 * @Title: CollectionConfirmationSwfTaskSpecifiedHandler
 * @Description: 工作流普通任务人员程序指定类
 * @author: yanweichao
 * @date: 2017-11-17
 * @version: V1.0
 */
public class CollectionConfirmationSwfTaskSpecifiedHandler extends AbstractExecHandler {
	...
	public Object execute(ExecContext execContext) {
		...
		return collectionConfirmation.getCreatedById();
	}
