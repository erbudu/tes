...
@MappedSuperclass
public class BaseOrderChange implements Serializable {
...
//	private String internalPersonId;
	...
	private Integer isAccusation;// 是否引起诉讼
	private Integer isStop;// 是否合同终止
	private double changeRate;//变更幅度
	/**
	 * 无参构造函数.
	 */
	public BaseOrderChange() {
	}
	 ...
	 * @param changeId
	 */
	public BaseOrderChange(String changeId) {
...
//	}
	...
	@Column(name = "IS_ACCUSATION", nullable = true, precision = 10)
	...
	@Column(name = "IS_STOP", nullable = true, precision = 10)
	...
	@Column(name = "CHANGE_RATE", nullable = true, precision = 10, scale = 3)
