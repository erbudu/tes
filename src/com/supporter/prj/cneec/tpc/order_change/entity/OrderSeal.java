...
import com.supporter.prj.cneec.tpc.order_change.entity.base.BaseOrderSeal;

@Entity
@Table(name = "TPC_ORDER_SEAL", schema = "")
public class OrderSeal extends BaseOrderSeal implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String MODULE_ID = "ORDSEAL";
	public static final String DOMAIN_OBJECT_ID = "orderSeal";
	...
	/** minimal constructor */
	public OrderSeal(String sealId) {
		super(sealId);
	}
