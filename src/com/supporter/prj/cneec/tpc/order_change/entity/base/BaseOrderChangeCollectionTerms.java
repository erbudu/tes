...
/**   
 * @Title: Entity
 * @Description: TPC_ORDER_CHANGE_COLLECT_TERMS,字段与数据库字段一一对应.
 */
@MappedSuperclass
public class BaseOrderChangeCollectionTerms implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseOrderChangeCollectionTerms() {
	}
	 ...
	 * @param termsId
	 */
	public BaseOrderChangeCollectionTerms(String termsId) {
