...
/**
 * @Title: TpcOrderChangeController
 * @Description: 控制器类
 * @author: yanweichao
 * @date: 2017-11-14
 * @version: V1.0
 */
@Controller
@RequestMapping("tpc/orderChange/build")
public class TpcOrderChangeController extends AbstractController {
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<OrderChange> listPage = this.service.getListPage(
			...
			System.out.println(TpcOrderChangeController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
