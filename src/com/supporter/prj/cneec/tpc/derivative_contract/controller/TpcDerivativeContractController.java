...
@Controller
@RequestMapping("tpc/derivativeContract/build")
public class TpcDerivativeContractController extends AbstractController {
	...
	@Autowired
	private DerivativeContractService managerService;
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<DerivativeContract> listPage = this.managerService.getListPage(
			...
			System.out.println(TpcDerivativeContractController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
