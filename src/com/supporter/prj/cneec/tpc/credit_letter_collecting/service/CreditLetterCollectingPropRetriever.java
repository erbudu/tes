 ...
 */
@Service
public class CreditLetterCollectingPropRetriever extends AbstractPropRetriever {
	
	/**
	 * 注入需要使用的Service.
	 */
	@Autowired
	private CreditLetterCollectingService service;
	@Autowired
	...
	protected Object getEntity(int budgetYear, Object entityId) {
		...
		CreditLetterCollecting entity = this.service.get(entityId.toString());
		RegisterProject prj = prjService.get(entity.getProjectId());
		entity.setPrjDeptId(prj.getProjectDeptId());
		entity.setPrjManagerId(prj.getProjectChargeId());
		return entity;
	}
