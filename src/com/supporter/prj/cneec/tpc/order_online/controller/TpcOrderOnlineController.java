...
/**
 * @Title: TpcOrderOnlineController
 * @Description: 控制器类
 * @author: yanweichao
 * @date: 2017-11-03
 * @version: V1.0
 */
@Controller
@RequestMapping("tpc/orderOnline/build")
public class TpcOrderOnlineController extends AbstractController {
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<OrderOnline> listPage = this.orderOnlineService.getListPage(
			...
			System.out.println(TpcOrderOnlineController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
