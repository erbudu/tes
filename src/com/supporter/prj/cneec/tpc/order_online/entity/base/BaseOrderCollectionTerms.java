...
/**   
 * @Title: Entity
 * @Description: TPC_ORDER_COLLECTION_TERMS,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2017-10-30
 * @version V1.0   
 *
 */
@MappedSuperclass
public class BaseOrderCollectionTerms implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseOrderCollectionTerms() {
	}
	 ...
	 * @param termsId
	 */
	public BaseOrderCollectionTerms(String termsId) {
