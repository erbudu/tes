package com.supporter.prj.cneec.tpc.external_quotation_review_dept.entity.base;
...
/**
 * @Title: Entity
 * @Description: TPC_EXTERNAL_QUOTATION_RV_DEPT,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2018-03-20 17:15:46
 * @version V1.0
 * 
 */
@MappedSuperclass
public class BaseExternalQuotationReviewDept implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseExternalQuotationReviewDept() {
	}
	 ...
	 * @param externalId
	 */
	public BaseExternalQuotationReviewDept(String externalId) {
