...
/**
 * @Title: ExternalQuotationReviewDeptSwfSpecifiedStartDeptHandler
 * @Description: 工作流组织树起始部门程序指定类
 * @author: yanweichao
 * @date: 2017-11-17
 * @version: V1.0
 */
public class ExternalQuotationReviewDeptSwfSpecifiedStartDeptHandler extends AbstractExecHandler {
	...
	public Object execute(ExecContext execContext) {
		...
		return externalQuotationReviewDept.getDeptId();
	}
