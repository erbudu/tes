package com.supporter.prj.cneec.tpc.derivative_contract_change.entity.base;
...
@MappedSuperclass
public class BaseDerivativeConChange implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseDerivativeConChange() {
	}
	 ...
	 * @param chId
	 */
	public BaseDerivativeConChange(String chId) {
		this.chId = chId;
	}
	...
	@Id
	@Column(name = "CH_ID", nullable = false, length = 32)
