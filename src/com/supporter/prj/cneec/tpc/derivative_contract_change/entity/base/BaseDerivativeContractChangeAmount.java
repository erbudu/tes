 ...
 */
@MappedSuperclass
public class BaseDerivativeContractChangeAmount implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseDerivativeContractChangeAmount() {
	}
	 ...
	 * @param amountId
	 */
	public BaseDerivativeContractChangeAmount(String amountId) {
