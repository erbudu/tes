 ...
 */
@MappedSuperclass
public class BaseDerivativeContractChange implements Serializable {
...
//	private String internalPersonId;
	 ...
	 * 无参构造函数.
	 */
	public BaseDerivativeContractChange() {
	}
	 ...
	 * @param changeId
	 */
	public BaseDerivativeContractChange(String changeId) {
