 ...
 */
@MappedSuperclass
public class BaseDerivativeContractChangeTerms implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseDerivativeContractChangeTerms() {
	}
	 ...
	 * @param termsId
	 */
	public BaseDerivativeContractChangeTerms(String termsId) {
