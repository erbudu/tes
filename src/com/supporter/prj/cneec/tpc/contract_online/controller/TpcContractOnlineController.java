 ...
 */
@Controller
@RequestMapping("tpc/contractOnline/build")
public class TpcContractOnlineController extends AbstractController {
	...
	public void getJsonData(JqGridReq jqGridReq, HttpServletResponse response) {
		...
		try {
			ListPage<ContractOnline> listPage = this.contractOnlineService.getListPage(
			...
			System.out.println(TpcContractOnlineController.class.getName() + ".getJsonData() Error:" + e.getMessage());
		}
	}
