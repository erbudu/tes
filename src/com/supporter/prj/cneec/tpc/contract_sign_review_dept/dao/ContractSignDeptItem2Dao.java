 ...
 */
@Repository
public class ContractSignDeptItem2Dao extends MainDaoSupport<ContractSignDeptItem2, String> {

	/**
	 * 分页查询
	 */
	public List<ContractSignDeptItem2> findPage(JqGrid jqGrid, Map<String, Object> parameters) {
	...
	public List<ContractSignDeptItem2> findList(Map<String, Object> parameters) {
		StringBuffer hql = new StringBuffer();
		hql.append("from " + ContractSignDeptItem2.class.getName());
		String filter = "";
	...
	public void removePurchaseValue(String inforId) {
		String hql = "update " + ContractSignDeptItem2.class.getName() + " set purchaseReviewId = null, purchaseContractId = null where purchaseContractId = ?";
