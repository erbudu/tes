 ...
 */
@Entity
@Table(name = "TPC_CONTRACT_SIGN_DEPT_ITEM2", schema = "")
public class ContractSignDeptItem2 extends BaseContractSignDeptItem implements ContractSignItemBean, Serializable {
	 ...
	 * @param itemId
	 */
	public ContractSignDeptItem2(String itemId) {
		super(itemId);
	}

	public ContractSignDeptItem2(int initialReviewType, String parentItemId, String parentItemName, String saleReviewId, String saleContractId) {
		super(initialReviewType, parentItemId, parentItemName, saleReviewId, saleContractId);
	}

	public ContractSignDeptItem2(int initialReviewType, String purchaseReviewId, String purchaseContractId) {
