...
/**
 * @Title: Entity
 * @Description: TPC_CONTRACT_SIGN_DEPT_AMOUNT,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2018-04-10
 * @version V1.0
 */
@MappedSuperclass
public class BaseContractSignDeptAmount implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractSignDeptAmount() {
	}
	 ...
	 * @param amountId
	 */
	public BaseContractSignDeptAmount(String amountId) {
		this.amountId = amountId;
	}

	public BaseContractSignDeptAmount(String inforId, String signId, int inforType, String currency, String currencyId) {
