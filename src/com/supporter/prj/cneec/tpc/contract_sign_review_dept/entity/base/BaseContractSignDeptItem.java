...
/**
 * @Title: Entity
 * @Description: TPC_CONTRACT_SIGN_DEPT_ITEM,字段与数据库字段一一对应.
 * @author Yanweichao
 * @date 2018-04-10
 * @version V1.0
 */
@MappedSuperclass
public class BaseContractSignDeptItem implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractSignDeptItem() {
	}
	 ...
	 * @param itemId
	 */
	public BaseContractSignDeptItem(String itemId) {
		this.itemId = itemId;
	}

	public BaseContractSignDeptItem(int initialReviewType, String parentItemId, String parentItemName, String saleReviewId, String saleContractId) {
	...
	public BaseContractSignDeptItem(int initialReviewType, String purchaseReviewId, String purchaseContractId) {
		this.initialReviewType = initialReviewType;
