package com.supporter.prj.cneec.pc.pre_prj_manager.pre_prj_develop_dept_adjust.dao;
 ...
 */
@Repository
public class DevelopDeptAdjustDao extends MainDaoSupport < DevelopDeptAdjust , String > {
	 ...
	 * @return
	 */
	public List<DevelopDeptAdjust> findPage(UserProfile user,JqGrid jqGrid, DevelopDeptAdjust filing) {
		String authHql = "";
		if (filing != null) {			
