 ...
 */
@Repository
public class PrePrjInfoAdjustDao extends MainDaoSupport < PrePrjInfoAdjust , String > {
	 ...
	 * @return
	 */
	public List<PrePrjInfoAdjust> findPage(UserProfile user,JqGrid jqGrid, PrePrjInfoAdjust filing) {
		String authHql = "";
		if (filing != null) {			
