 ...
 */
@Repository
public class PrePrjInfoAdjustCompDao extends MainDaoSupport < PrePrjInfoAdjustComp , String > {
	 ...
	 * @return
	 */
	public List<PrePrjInfoAdjustComp> findPage(UserProfile user,JqGrid jqGrid, PrePrjInfoAdjustComp filing) {
		if (filing != null) {			
