...
/**
 *<p>Title: EndHandler</p>
 *<p>Description: 申报准备 -流程结束服务类</p>
 *<p>Company: </p>
 * @author YUEYUN
 * @date 2019年9月4日
 * 
 */
public class EndHandler extends AbstractExecHandler{
	...
	public Object execute(ExecContext execContext) {
		StartService startService = (StartService)SpringContextHolder.getBean(StartService.class);
		    ...
		    if (entity != null) {
		    	...
		    	entity.setStatus(StartContant.COMPLETE);//流程状态-审批完成
		    	startService.update(entity);
		    	PPMService.getScheduleStatusService().saveScheduleStatus(entity.getPrjId(), "preparation04", null);
		    } else {
