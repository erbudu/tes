...
import com.supporter.prj.ppm.ecc.wg_review.entity.base.BaseEccWgReview;
 ...
 */
@Entity
@Table(name = "PPM_ECC_WG_REVIEW", schema = "")
public class EccWgReview extends BaseEccWgReview implements Serializable {

	private static final long serialVersionUID = 1L;
	public static final String MODULE_ID = "PpmEccWg";
	 ...
	 * @param eccWgId
	 */
	public EccWgReview(String eccWgId) {
		super(eccWgId);
	}

	private EccDeptReview deptReview;
	@Transient
	public EccDeptReview getDeptReview() {
		return deptReview;
	}

	public void setDeptReview(EccDeptReview deptReview) {
		this.deptReview = deptReview;
	}
