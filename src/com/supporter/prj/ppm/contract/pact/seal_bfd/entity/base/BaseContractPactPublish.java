...
@MappedSuperclass
public class BaseContractPactPublish implements Serializable {

	private static final long serialVersionUID = 1L;
	private String publishId; // 主键ID
	private String publishNo; // 主键ID
	...
	private java.util.Date startDate; // 出版开始日期
	private java.util.Date endDate; // 出版完成日期
	 ...
	 * 无参构造
	 */
	public BaseContractPactPublish() {
	}
	 ...
	 * @param publishId
	 */
	public BaseContractPactPublish(String publishId) {
	 ...
	 * 全参构造
	 */
	public BaseContractPactPublish(String publishId, String publishNo, String contractPactName, String contractPactType, String prjId, String prjName,
	...
	@Id
	@Column(name = "PUBLISH_ID", nullable = false, length = 32)
	...
	@Column(name = "PUBLISH_NO", nullable = true, length = 32)
