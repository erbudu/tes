 ...
 */
@MappedSuperclass
public class BaseContractSignRevVer implements Serializable {
	 ...
	 * @param reviewVerId
	 */
	public BaseContractSignRevVer(String reviewVerId) {
	 ...
	 */
	@Column(name = "CONTRACT_SIGN_REV_CON_ID", nullable = true, length = 32)
	 ...
	 * @return: int 审批结果
	 */
	@Column(name = "RESULT", nullable = true, length = 128)
