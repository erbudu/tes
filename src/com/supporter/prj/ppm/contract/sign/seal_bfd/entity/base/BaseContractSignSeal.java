 ...
 */
@MappedSuperclass
public class BaseContractSignSeal implements Serializable {
	 ...
	 * @param signSealId
	 */
	public BaseContractSignSeal(String signSealId) {
	...
	@Column(name = "SIGN_SEAL_ID", nullable = false, length = 32)
