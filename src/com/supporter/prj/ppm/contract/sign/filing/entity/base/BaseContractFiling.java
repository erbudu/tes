 ...
 */
@MappedSuperclass
public class BaseContractFiling implements Serializable {
	...
	@Column(name = "CONTRACT_RANGE", nullable = true, length = 512)
	 ...
	 * @param filingId
	 */
	public BaseContractFiling(String filingId) {
