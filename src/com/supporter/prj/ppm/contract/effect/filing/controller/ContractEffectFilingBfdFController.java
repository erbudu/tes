...
import com.supporter.prj.ppm.contract.effect.filing.service.ContractEffectFilingBfdFService;
 ...
 */
@Controller
@RequestMapping("contract/effect/filing/contractFilingBfdF")
public class ContractEffectFilingBfdFController extends AbstractController {

	private static final long serialVersionUID = 1L;

	@Autowired
	private ContractEffectFilingBfdFService contractFilingBfdFService;
	...
	public @ResponseBody ContractEffectFilingBfdF initEditOrViewPage(String recordId) {
		ContractEffectFilingBfdF entity = contractFilingBfdFService.initEditOrViewPage(recordId);
		return entity;
	}
	...
	public @ResponseBody JqGrid getGrid(HttpServletRequest request, JqGridReq jqGridReq, ContractEffectFilingBfdF contractFilingBfdF) throws Exception {
	...
	public @ResponseBody OperResult< ? > saveOrUpdate(ContractEffectFilingBfdF contractFilingBfdF) {
		UserProfile user = this.getUserProfile();
		ContractEffectFilingBfdF entity = this.contractFilingBfdFService.saveOrUpdate(user, contractFilingBfdF);
