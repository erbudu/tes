 ...
 */
@MappedSuperclass
public class BaseContractEffectFilingBfdF implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractEffectFilingBfdF() {
	}
	 ...
	 * @param recordId
	 */
	public BaseContractEffectFilingBfdF(String recordId) {
