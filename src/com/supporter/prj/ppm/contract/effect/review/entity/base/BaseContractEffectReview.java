...
/**
 * @Title: Entity
 * @Description: 生效评审表,字段与数据库字段一一对应.
 * @author: YAN
 * @date: 2019-09-06
 * @version: V1.0
 */
@MappedSuperclass
public class BaseContractEffectReview implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractEffectReview() {
	}
	 ...
	 */
	public BaseContractEffectReview(String contractEffectReviewId) {
	...
	@Column(name = "CONTRACT_EFFECT_REVIEW_ID", nullable = false, length = 32)
