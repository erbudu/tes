 ...
 */
@MappedSuperclass
public class BaseContractEffectReport implements Serializable {
	 ...
	 * 无参构造函数.
	 */
	public BaseContractEffectReport() {
	}

	/**
	 * 构造函数.
	 *
	 * @param contrac.effectId
	 */
	public BaseContractEffectReport(String contractEffectId) {
	...
	@Column(name = "CONTRACT_Effect_ID", nullable = false, length = 32)
	...
	/**
	 * 方法: 取得项目报审原因
	 * @return: java.math.BigDecimal 报审原因
	 */
	...
	/**
	 * 方法: 设置项目报审原因
	 * @param: java.math.BigDecimal 项目报审原因
	 */
