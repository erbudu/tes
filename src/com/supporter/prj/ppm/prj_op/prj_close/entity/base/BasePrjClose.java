package com.supporter.prj.ppm.prj_op.prj_close.entity.base;
...
@MappedSuperclass
public class BasePrjClose implements Serializable {
	...
	private int hasSigned; // 是否签订相关协议
	 ...
	 * 全参构造
	 */
	public BasePrjClose(String id, String prjId, String prjNameZh, String prjNameEn, String closeReason, int hasSigned, String explain,
			String deptId, String deptName, String contactNameId, String contactName, String contactNumber, int status, Date submitDate,
			String creator, String creatorId, Date creationDate, String modifier, String modifierId, Date modificationDate, String procId) {
		this.id = id;
		this.prjId = prjId;
	...
	@Column(name = "close_reason", nullable = false, length = 512)
	...
	@Column(name = "has_signed", nullable = false, precision = 10)
