 ...
 */
@MappedSuperclass
@IdClass(value=CsSerialMonUniformNoKey.class)
public class BaseCsSerialMonUniformNo implements ISerialNoEntity, Serializable {
    ...
    public BaseCsSerialMonUniformNo(CsSerialMonUniformNoKey key) {
        this.serialNumberId = key.getSerialNumberId();
        this.month = key.getMonth();
        this.year = key.getYear();
    }

    public BaseCsSerialMonUniformNo() {
        super();
    }
