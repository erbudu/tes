 ...
 */
@MappedSuperclass
@IdClass(value=CsSerialMonCompanyNoKey.class)
public class BaseCsSerialMonCompanyNo implements ISerialNoEntity, Serializable {
	...
	public BaseCsSerialMonCompanyNo(CsSerialMonCompanyNoKey key) {
	...
	public BaseCsSerialMonCompanyNo() {
		super();
	}
