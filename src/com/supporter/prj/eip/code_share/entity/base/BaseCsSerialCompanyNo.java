 ...
 */
@MappedSuperclass
@IdClass(value=CsSerialCompanyNoKey.class)
public class BaseCsSerialCompanyNo implements ISerialNoEntity, Serializable {
	...
	public BaseCsSerialCompanyNo(CsSerialCompanyNoKey key) {
		this.serialNumberId = key.getSerialNumberId();
		this.deptId = key.getDeptId();
	}
	
	public BaseCsSerialCompanyNo() {
		super();
	}
