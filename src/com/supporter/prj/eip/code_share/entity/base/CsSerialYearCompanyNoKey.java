 ...
 *
 */
public class CsSerialYearCompanyNoKey implements Serializable {
	...
	public CsSerialYearCompanyNoKey(int year, String serialNumberId, String deptId) {
		this.year = year;
		this.serialNumberId = serialNumberId;
		this.deptId = deptId;
	}
	
	public CsSerialYearCompanyNoKey() {
		super();
	}
