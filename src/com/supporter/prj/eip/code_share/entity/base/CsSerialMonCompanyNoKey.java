 ...
 *
 */
public class CsSerialMonCompanyNoKey implements Serializable {
	...
	public CsSerialMonCompanyNoKey(int year, int month, String serialNumberId, String deptId) {
		this.year = year;
		this.month = month;
	...
	public CsSerialMonCompanyNoKey() {
		super();
	}
