package com.supporter.prj.eip.code_share.code.old.service;
 ...
 *
 */
@RequestMapping(value = "codeShareForOld", produces = "text/plain;charset=utf-8;", consumes = "text/plain;charset=utf-8;")
@WebService(targetNamespace = "http://service.old.code.code_share.eip.prj.supporter.com/")
public interface ICodeShareServiceForOld {
	/**
	 * 用于简单测试
	 * @param msg 输入参数
	 * @return String
