 ...
 *
 */
@Service("codeShareServiceImplForOld")
@WebService(endpointInterface = "com.supporter.prj.eip.code_share.code.old.service.ICodeShareServiceForOld")
public class CodeShareServiceImplForOld implements ICodeShareServiceForOld {
	@Autowired
